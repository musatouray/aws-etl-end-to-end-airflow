...
│                         aws-etl-airflow and configuration for tools like black
│
...
│
└── aws-etl-airflow   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes aws-etl-airflow a Python module
    │
